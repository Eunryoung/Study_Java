...
public class Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 *   => Runnable 인터페이스의 임시 구현 객체 형태를 Thread 생성자에 전달
		 *   
		 * < 기본 문법 >
		 * Thread t = new Thread(new Runnable() { // Runnable 인터페이스의 임시 구현객체이므로 
		 * 										  // new 키워드 다음 Runnable 나옴
		 * 		@Override
		 * 		public void run() {
		 * 			// 멀티쓰레딩으로 구현할 코드를 기술
		 * 		}
