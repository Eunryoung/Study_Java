...
//		int channel#5; // 사용 불가! ($ 또는 _ 만 사용가능)
		// => (Syntax error on token "Invalid Character", = expected_ 
		
		// 3. 대소문자 구별
		int age; // 소문자 age 와
		int AGE; // 대문자 AGE 는 다른(식별자) 변수로 취급됨
...
//		int char;   // 키워드 char 사용 불가
		...
		// 5. 공백 사용 불가
//		int my name; // 사용불가
		int my, name; // int형 변수 my 와 int형 변수 name을 동시에 선언
		// int my;
		// int name; 두줄과 똑같다
		
		// 6. 한글 사용 가능( 하지만 변수명으로는 사용하지 않음)
		int 나이;
	}
