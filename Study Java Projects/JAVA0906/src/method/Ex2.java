...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		// 메서드 호출 시 전달할 데이터는 메서드명 뒤의 소괄호 내 기술
//		sister_3(10000); // 메서드 파라미터에 리터럴값을 직접 전달하거나
		...
		System.out.println("동생아! 1만원을 줄테니 내 버터링쿠키도 사줘!");
		String snack = sister_4(10000);
		System.out.println("동생이 사다준 것 : " + snack);
		
//		System.out.println("동생이 사다준 것 : " + sister_4(10000));
	...
	public static void sister_3(int money) {
		...
		// => sister_3(10000) 호출 시 int money = 10000과 동일한 코드로 취급됨
...
//	}
	...
	public static String sister_4(int money) {
		System.out.println("동생 : 오빠가 준 돈 = " + money + "원");
		money -= 2000;
		System.out.println("동생 : 과자를 사고 " + money + "원이 남았다!");
		
		// 문자열 "버터링쿠키"를 리턴
//		return "버터링쿠키", "콜라"; // 주의! return문 뒤의 값은 하나만 기술!
		return "버터링쿠키"; 
	}
