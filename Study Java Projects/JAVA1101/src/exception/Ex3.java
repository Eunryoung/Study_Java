...
//		}
	...
	public static void 사원() throws ArithmeticException, NullPointerException { 
		// => 사원()을 호출한 대리()가 예외처리 하거나
		//    대리도 throws를 이용해 팀장()에게 다시 위임
		
//		System.out.println("사원에서 예외 발생");
//		System.out.println(3 / 0); // ArithmeticException 예외 발생하는 코드

		// 예외 처리 방법
		// 1. 예외가 발생한 곳에서 try ~ catch로 직접 예외 처리
//		try {
//			System.out.println("사원에서 예외 발생");
//			System.out.println(3 / 0); // ArithmeticException 예외 발생하는 코드
//		} catch(ArithmeticException e) {
