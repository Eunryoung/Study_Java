...
public class Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 *   (e.g. Exception 클래스를 상속받은 서브클래스 정의)
...
//			throw e;
			...
			// => Add throws declaration 처리!
			
			// 위의 방법은 Exception 객체의 변수 e를 한 번 쓰고 버리므로
...
//			throw new InvalidScoreException("점수 입력 오류 - " + score);
			// => Add throws declaration 처리 하면 호출한 곳으로 예외 처리를 넘김
			throw new InvalidScoreException("점수 입력 오류 - " + score);
		}
	}
