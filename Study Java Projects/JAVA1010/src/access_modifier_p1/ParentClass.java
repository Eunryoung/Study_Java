...
public class ParentClass {
	...
	int defaultVar; // default는 기본값. 명시하면 오히려 오류 발생!
	private int privateVar;
	
	public void useMember() {
		// 자신의 클래스 내의 멤버에 접근 시 아무런 제약이 없음(값 지정 가능하단 건 접근 가능하다는 뜻)
		this.publicVar = 10;	// public(접근 가능)
		this.protectedVar = 20; // protected(접근 가능)
		this.defaultVar = 30;	// default(접근 가능)
		this.privateVar = 40; // private(접근 가능)
	}
}
