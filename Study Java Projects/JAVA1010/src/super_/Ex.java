...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * 슈퍼클래스의 멤버변수와 메서드는 은닉되어 보이지않게 된다!
...
class Child extends Parent {
	...
	String tv = "내가 구입한 TV"; // 멤버변수 오버라이딩
 ...
 * - 메서드 내에서 접근할 수 있는 변수 종류 : 로컬변수, 자신의 멤버변수, 부모의 멤버변수
 * - 메서드 내에서 접근 순서
...
class ChildClass extends ParentClass {
	...
	public void method() {
		...
		// => 만약, 로컬변수를 선언하지 않을 경우 이 x는 this.x와 동일
		
		System.out.println("this.x = " + this.x); // 서브클래스 멤버변수 x
		// => 만약, Child 클래스 멤버변수를 선언하지 않을 경우 이 x는 super.x와 동일
